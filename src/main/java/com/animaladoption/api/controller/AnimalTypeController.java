...
public class AnimalTypeController {
	...
	public ResponseEntity<Page<AnimalTypeDTO>> findAll(Pageable pageable) {
	...
	public ResponseEntity<AnimalTypeDTO> add(@Valid @RequestBody AnimalTypeDTO dto) {
	...
	public ResponseEntity<AnimalTypeDTO> update(@PathVariable UUID id, @Valid @RequestBody AnimalTypeDTO dto) {
